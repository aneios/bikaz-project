...
const BikazProjectIndexerProcessor: JSProcessor<MergedAbis<typeof contractsInfo.contracts>, Data> = {
...
export const createProcessor = fromJSProcessor(() => BikazProjectIndexerProcessor);
