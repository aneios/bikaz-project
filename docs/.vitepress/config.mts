...
export default defineConfig({
  base: isRunningOnVercel ? '/' : '/bikaz-project/',
  title: "Bikaz Project",
  description: "Build and Deploy for Eternity. Bikaz Project is a production-ready template for decentralised applications.",
  head: [
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/wighawag/bikaz-project#readme' },
